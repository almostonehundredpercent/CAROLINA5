...
Route::get('/', fn () => view('home', ['featuredRooms' => Room::where('is_active', true)->where('operational_status', 'available')->orderBy('price_per_night')->take(3)->get(), 'availabilityRooms' => Room::where('is_active', true)->where('operational_status', 'available')->orderBy('name')->get()]))->name('home');
