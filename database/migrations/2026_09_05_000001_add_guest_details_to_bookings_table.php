...
return new class extends Migration {
    ...
    public function down(): void { Schema::table('bookings', function (Blueprint $table) { $table->dropIndex(['guest_email']); $table->dropColumn(['guest_name', 'guest_email', 'guest_phone', 'billing_street', 'billing_city', 'billing_province', 'billing_postal_code', 'billing_verified_at']); $table->foreignId('user_id')->nullable(false)->change(); }); }
};
