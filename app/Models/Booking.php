...
{
    protected $fillable = ['user_id', 'guest_name', 'guest_email', 'guest_phone', 'room_id', 'reference', 'check_in', 'check_out', 'check_in_at', 'check_out_at', 'booking_type', 'hours', 'guests', 'children_count', 'pets_count', 'nights', 'total_amount', 'hold_expires_at', 'status', 'payment_method', 'special_request', 'add_ons', 'staff_notes', 'checked_in_at', 'checked_out_at'];
