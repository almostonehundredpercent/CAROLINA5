...
<section class="section compact">
    <form class="filter-bar rooms-search" method="GET">
        ...
        <label class="rooms-time-field" id="rooms-time-field" hidden><span>Arrival time</span><input name="check_in_time" type="time" value="{{ $filters['check_in_time'] ?? '12:00' }}"></label>
