    ...
    <section class="deposit-card">
        ...
        @if(! $paymentComplete)
            <div class="deposit-instructions">
                ...
                <img src="https://carolina5-web.onrender.com/images/gcash-qr.png" alt="Carolina GCash payment QR" style="width:160px;max-width:100%;margin:8px 0;border-radius:7px">
